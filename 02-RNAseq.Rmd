...
# -----------------------------------------------
# parsing output of geneBody_coverage.py in R
...
tibble(filename = basename(x) %>% str_extract(pattern = "^\\w+"),
       ...
       percentile_rank = percent_rank(counts), #correct?
       percentile = 1:100) 
}
