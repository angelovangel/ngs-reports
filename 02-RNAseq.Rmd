...
align_outfiles <- file.path(align_outdir, paste(tools::file_path_sans_ext(basename(for_files)), ".subread.BAM", sep = ""))
  ...
  if (!is.null(params$fastq_dir)) {
    ...
    # first check if there are bams already
      if (length(bamfiles) > 0) {
        ...
        # if align was performed before, align_summary.rds should be present in the fastq folder
